        ...
        <section class="fields">
            <div class="categories">
                    ...
                    <div class="categ">
                      <div class="sub1">
                        <ul>
                          <li><a href="../pages/field/accounting.php">Accounting and Finance</a></li>
                          <li><a>Administration</a></li>
                          <li><a>Art and creative</a></li>
                          <li><a>Banking</a></li>
                          <li><a>Business and Management</a></li>
                          <li id="toggle1"><a>Computer Science</a>
                              <i class="glyphicon glyphicon-chevron-down"></i>
                              <ul class="unstyled inner inner1"> 
                                  <li><a href="../pages/subfield/web.php">Web Development</a></li> 
                          ...
                          <li><a>Education and Teaching</a></li>
                        </ul>
                      </div>

                        <div class="sub2">
                          <ul>
                            <li id="toggle2"><a>Engineering</a> 
                            <i class="glyphicon glyphicon-chevron-down"></i>
                            <ul class="inner inner2"> 
                                <li><a href="../pages/subfield/arch.php">Architecture Engineering</a></li> 
                                <li><a>Civil Engineering</a></li> 
                                <li><a>Computer Engineering</a></li> 
                                <li><a>Enviromental Engineering</a></li> 
                            </ul> 
                            </li>
                            <li><a>Healthcare and Medical</a></li>
                            <li><a>Languages</a></li>
                            <li><a>Law</a></li>
                            <li><a>Marketing</a></li>
                            <li><a>Sales and Busisness Development</a></li>
                            <li><a>Tourism</a></li>
                          </ul>
                        </div>
                    </div>
