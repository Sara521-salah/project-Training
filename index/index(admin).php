...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-inverse navbar-custom navbar-fixed-top">
          <div class="container-fluid"> <!-- fluid is used so that the container takes up the whole space of the page with no margins on the sides -->
            ...
            <!-- aria expanded when set to false means that the objects in the toggle menu are collapsed -->
              ...
              <a class="navbar-brand" href="index(admin).php">TrainMe</a> <!--a link that directs the user to the same page (#) -->
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse">                
              <ul class="nav navbar-nav navbar-right">
                <li class="header-active home-link"><a href="index(admin).php"><span class="glyphicon glyphicon-home"></span>  Home</a></li>
        ...
        <div class="breadcrumb-holder" style="padding-top: 15px;padding-right: 150px;font-size: 22px;padding-bottom: 12px;">
          <div class="container-b" style="height: 30px;">
            <ul class="navbar-nav navbar-right">
              <li id="add"><a href="../pages/addfield(admin).php" style="padding-top: 0px; cursor: pointer;padding-right: 20px;">Add Field?</a></li>
              <li id="delete"><a href="../php/delete(field)(admin).php" style="margin-right: -15%; padding-top: 0px; cursor: pointer;">Delete Field?</a></li>
            </ul>
          </div>
        </div>
                    ...
                    try{
                          ...
                          while($row = mysqli_fetch_assoc($query)) {
                            if($row["name_field"]=="Accounting and Finance"){
                              ?>
                              <ul>
                                  <li><a href="../pages/field/accounting(admin).php"><?php echo $row["name_field"]?></a></li> 
                              </ul>
                            <?php 
                                }
                         ...
                         <?php 
                            ...
                            <?php 
                             ...
                             elseif($row["name_field"]=="Computer Science" && $row["sub_field"]=="Web Development"){
                              ...
                              <ul>
                              <ul class="unstyled inner inner1" style="padding-top: 0px;">
                                  <li><a href="../pages/subfield/web(admin).php"><?php echo $row["sub_field"]?></a></li> 
                              </ul>
                              </ul>
                            <?php 
                                }
                                ...
                                <div class="sub2">
                                  ...
                                  <i class="glyphicon glyphicon-chevron-down"></i> </li>
                                    <ul class="inner inner2" style="padding-top: 0px;">
                                        <li><a href="../pages/subfield/arch(admin).php"><?php echo $row["sub_field"]?></a></li> 
                                    </ul>
                                  </ul>
                                <?php 
                                    }
