          ...
          if ( $_SERVER['REQUEST_METHOD'] == "POST"){
            if(empty($_POST['choice'])){
              ...
              try{
                ...
                ?>
            <div class = "header">
                <h1 class="pr" style="font-size: 45px; margin-top:7%;margin-right: 55px;color: #EDEDED;">All Trainees</h1>
            </div>
            ...
            <?php
                      ...
                      <a href="../php/logout.php" style="width: 13%;margin:5% 0px 5% 42%; font-size: 19px;line-height: 30px;" class = "btn btn-primary">Logout</a>
                </div>
            </div>
    <footer>
