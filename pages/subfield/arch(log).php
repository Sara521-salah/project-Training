        ...
        <nav class="navbar navbar-default navbar-inverse navbar-custom navbar-fixed-top">
          ...
          <?php 
                ...
                <div class="login-check" style="height: 300%;display: block;width: 41%;left: 30%;margin-top: 12%;">
                      ...
                      <form action="../php/check(arch).php" method="POST"></form>
                        <input class="check" type="submit" value="Try Again" style="text-align: center;font-size: 17px;
                ...
                <div class="login-check-company" style="height: 300%;display: block;width: 41%;left: 30%;margin-top: 12%;">
                      ...
                      <form action="../php/check(arch)(comp).php" method="POST"></form>
            ...
            <div class="breadcrumb-holder">
              <div class="container-b" style="height: 30px;">
                <ul class="navbar-nav navbar-right">
                  <li id="add"><a href="../training(form)(log).php" style="padding-top: 0px; cursor: pointer;">Add Training?</a></li>
                  <li id="add"><a href="../../php/delete(arch).php" style="margin-right: -15%; padding-top: 0px; ">Delete Training?</a></li>
                </ul>
              </div>
            </div>
                   ...
                   try{
                    if(!isset($_POST['submit']))
                    {
                      ...
                      while($row = mysqli_fetch_assoc($query)) {
                       if($row["field"]=="Engineering" && $row["sub_field"]=="Architecture Engineering"){
                      ?>
                     <?php $code= $row['code']; ?>
                      ...
                      <span class="company-name" style="font-size: 22px;">
                          ...
                          <br><br>                 
                          <span>Email: </span><a style="text-decoration: none;" href= "<?php echo $code ?>" class="location location-desktop"><span><?php echo $row["email"]?></span></a>
                          <br>
                    ...
                    <?php $code= $row['code']; ?>
                      <div class="company-meta" id="first">
                          <span class="company-name" style="font-size: 22px;">
                                  <a style="text-decoration: none;" href= "../details(log).php" title="Training"><span><?php echo $row["title"]?></span></a>
                              </span>
                              <br><br>                 
                              <span>Email: </span><a style="text-decoration: none;" href= "<?php echo $code ?>" class="location location-desktop"><span><?php echo $row["email"]?></span></a>
                              <br>
