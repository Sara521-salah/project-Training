    ...
    <body>
            ...
            <!-- aria expanded when set to false means that the objects in the toggle menu are collapsed -->
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse">                
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li><a href="profile(comp).php" ><span class="glyphicon glyphicon-user"></span></a></li>
                </ul>  
                </div>
              </div>
            </nav>
      <div class = "all" >
        <div class ="container">
           ...
           session_start(); 
            ...
            if ( $_SERVER['REQUEST_METHOD'] == "POST"){
              ...
              try{
                ...
                $choose = $_SESSION['choose'];
                $stm = $conn->query("SELECT * from send_receive WHERE code = $choose");       
               }
          ...
          <!--Training_info-->
          <form action="../php/addFeedback(comp).php" method="POST">
            <div class="form-group training" style="height: 666px;width: 200%;">

                <div>
                  <label class="control-label" style="display: inline-block;margin-left: 30px">Trainee Name</label>

              <select name="name" class="form-control" style="width: 50%; margin-left: 17%; outline: none; height: 34px;margin-top: -3%;" action="../php/addFeedback(comp).php">
              <?php  
                 while($row = $stm->fetch(PDO::FETCH_ASSOC))
                 {
                     $national_ids= array($row["national_id"]);
                     foreach($national_ids as $id)
                     {
                       $stm2 = $conn->query("SELECT national_id,first_name from trainee WHERE  national_id = '$id' ")->fetchAll(PDO::FETCH_KEY_PAIR);
                           foreach ($stm2 as $value){
              ...
              ?>
                ...
                <div class="">
                  <label  class="control-label" style="display: inline-block;margin-left: 30px;margin-top: 3%;">Training Code</label>
                  <input type="text" class="form-control" name = "code" style="margin-left: 30px;display: inline-block;width:50%;margin-bottom: 0px;" placeholder="Enter Traning Code" value= "<?php echo htmlspecialchars($choose); ?>" readonly >
                </div>
              
                
                <div class=" general" style="margin-top: 3%;">
                  <label  style="margin: 17px;font-size: 20px;margin-left: 2.5%;">Overall satisfaction with the trainee's performance?</label>
                  <div class="rating" style="top:57%;left: 65%;">
                ...
                <div class=" general" >
                  <label  style="margin: 17px;font-size: 20px;margin-left: 2.5%;">Behavior towards other trainees and supervisors?</label>
                  <div class="rating" style="top:66%;left: 65%;" >
                ...
                <div class="general">
                  <label style="margin: 17px;font-size: 20px;margin-left: 2.5%;">Attendance regularity?</label>
                  <div class="rating" style="top:74.5%;left: 65%;">
                ...
                <div class="general">
                  <label  style="margin: 17px;font-size: 20px;margin-left: 2.5%;" >Ability to follow the schedule?</label>
                  <div class="rating" style="top:82.5%;left: 65%;">
                ...
                <div class="general">
                  <label  style="margin: 17px;font-size: 20px;margin-left: 2.5%;" >Participation and interaction throughout the program?</label>
                  <div class="rating" style="top:90.5%;left: 65%;">
