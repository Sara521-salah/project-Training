    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-inverse navbar-custom navbar-fixed-top">
          <div class="container-fluid"> <!-- fluid is used so that the container takes up the whole space of the page with no margins on the sides -->
            ...
            <div class="login-view" style="display: block;width: 90%;left: 5%;height:70%;margin-top:8%;">
              <div class="close" style="margin-bottom: 0px;"><i class="fa fa-window-close"></i></div>
              <div class="login-text" style="margin: 5% 0px 0px 5%;">Your form was submitted successfully.</div>
              <div class="login-text" style="margin: 0% 0px 0px 0%;">Please wait for a response regarding your submission.</div>
              <form action="../index/index(log).php" method="POST">
                <input type="submit" value="OK" style="font-size:20px;margin: 5% 39%;">
              </form>
            </div>
        ...
        <div class ="container">
          ...
          <form action="../php/addDataTrainee.php" method="POST">
            ...
            <label class="col-sm-2 control-label col-xs-12 ">Age :</label>
                ...
                <div class = "col-sm-4 col-xs-12">
                  <input name="higher_degree" class="form-control" cols = "30" style="margin-top: 20px; margin-left:-30px;" placeholder="Enter your higher degree">
                </div>
