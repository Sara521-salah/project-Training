    ...
    <body>
        ...
        <?php  
            ...
            try{
              ...
              $sql = $conn->query("SELECT code,title from training_info WHERE field = 'Accounting and Finance'")->fetchAll(PDO::FETCH_KEY_PAIR);  
            }
        ...
        <div style="text-align: center; min-height: 500px; background-color:lightslategray; padding-top: 260px;"> 
          <form action="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
          <label style="font-size: 26px; line-height: 55px; text-shadow: 1px 0px 2px #093c52;margin-left: 0%;">Choose Title</label>
              ...
              if ( $_SERVER['REQUEST_METHOD'] == "POST"){
                if(empty($_POST['choice'])){
                  ...
                  try{
                    ...
                    header("location:../pages/field/accounting(admin).php");
                  }
                  catch(PDOException $e){
                    echo $e->getMessage();
                  }
