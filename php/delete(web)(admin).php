    ...
    <body>
        ...
        <?php  
            ...
            try{
              ...
              $sql = $conn->query("SELECT code,title from training_info WHERE sub_field = 'Web Development'")->fetchAll(PDO::FETCH_KEY_PAIR);  
            }
              ...
              if ( $_SERVER['REQUEST_METHOD'] == "POST"){
                if(empty($_POST['choice'])){
                  ...
                  try{
                    ...
                    header("location:../pages/subfield/web(admin).php");
                  }
                  catch(PDOException $e){
                    echo $e->getMessage();
                  }
