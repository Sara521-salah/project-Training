...
if ( $_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if( empty($_POST['Email_trainee']) ==  true || empty($_POST['Password_trainee']) ==  true){
        header("location:../pages/detailss.php");
        exit();        
    }
